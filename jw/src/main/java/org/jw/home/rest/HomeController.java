...
public class HomeController {
	...
	public void home(HttpServletRequest request, HttpServletResponse response) {
		...
		html.append("<td align=\"center\">Service x"+ClassHelper.getServiceClassSet().size()+"</td>");
	...
	public void action(HttpServletRequest request, HttpServletResponse response, String basePathHashCode) {
		...
		for (String mappingPath : mappingPathList) {
			...
			for (Handler handler : action) {
				...
				html.append("<td align=\"left\"><a href=\"" + contextPath + "/jw/controller-" + hashCode + "/action\">"
						+ handler.getControllerClass().getName() + "</a></td>");
				hashCode = null;
...
//		 HtmlUtil.convertHtmlCode("src/main/java/org/jw/home/rest/home.html");
		...
		// HtmlUtil.convertHtmlCode("src/main/java/org/jw/home/rest/tns.html");
//		HtmlUtil.convertHtmlCode("src/main/java/org/jw/home/rest/dao.html");
		HtmlUtil.convertHtmlCode("src/main/java/org/jw/home/rest/dataSource.html");
	}
}
